...
Within the Library class the lowOption variable should typically stay unchanged, 
but the high option should always correspond to the exit option for the user.
...
This is a re-creation of a earlier school project, as stated before.
I thought it would be good practice in getting acquainted with GitHub.

Once the bulk of the project is complete, I'll be practicing making branches 
and merging with new experimental add ons / features.
This Library system is about as scalable as a lemonade stand, 
